...
Opening a pull request will trigger a[workflow](../.github/workflows/eo_mlops_project-run-tests.yml) 
...
Links:
* [Staging model in UC](https://adb-984752964297111.11.azuredatabricks.net/explore/data/models/staging/eo_mlops_project/eo_mlops_project-model)
* [Prod model in UC](https://adb-984752964297111.11.azuredatabricks.net/explore/data/models/prod/eo_mlops_project/eo_mlops_project-model)
. 
